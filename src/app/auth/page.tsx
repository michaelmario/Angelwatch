  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 bg-slate-50 min-h-screen">
      <Link href="/" className="flex items-center gap-2 mb-8 group">
        ...
        <span className="text-2xl font-bold text-[#0a111a] tracking-tight uppercase">AngelWatch</span>
      </Link>
      ...
      <Card className="w-full max-w-md border-none shadow-2xl rounded-3xl overflow-hidden bg-white">
        <Tabs defaultValue="client" className="w-full">
          <TabsList className="grid w-full grid-cols-2 rounded-none h-14 bg-slate-100">
            <TabsTrigger value="client" className="data-[state=active]:bg-white data-[state=active]:text-[#0a111a] font-bold text-xs uppercase tracking-widest">Client</TabsTrigger>
            <TabsTrigger value="driver" className="data-[state=active]:bg-white data-[state=active]:text-accent font-bold text-xs uppercase tracking-widest">Chauffeur</TabsTrigger>
          </TabsList>
          ...
          <div className="p-8">
            <TabsContent value="client" className="mt-0 space-y-6 animate-in fade-in duration-500">
              <div className="space-y-2 text-center">
                ...
                <p className="text-muted-foreground text-sm">Sécurisez vos trajets nocturnes dès maintenant.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <Button 
                  className="w-full h-12 bg-[#0a111a] hover:bg-[#1a2c42] text-white font-bold rounded-xl uppercase tracking-widest text-xs"
                  disabled={loading}
            ...
            <TabsContent value="driver" className="mt-0 space-y-6 animate-in fade-in duration-500">
              <div className="space-y-2 text-center">
                ...
                <p className="text-muted-foreground text-sm">Connectez-vous pour commencer votre mission.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <Button 
                  className="w-full h-12 bg-accent hover:bg-accent/90 text-white font-bold rounded-xl uppercase tracking-widest text-xs shadow-lg"
                  disabled={loading}
      ...
      <button 
        className="mt-8 text-sm text-slate-500 hover:text-[#0a111a] font-medium transition-colors"
